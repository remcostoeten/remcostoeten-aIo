Nano Banana 2 image generation prompt for the `strong-types` README skill badge.
...
Subject: a foundry casting loose shape-shifting blobs into crisp interlocking typed blocks along guarded connector rails with shield gates rejecting misfit pieces.
